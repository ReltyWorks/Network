...
namespace Game.Net.Lobbies
{
    public class LobbiesView : MonoBehaviour
    {
        ...
        UserInLobbySlot _userInLobbySlot;
        ...
        private void Awake()
        {
            ...
            _userInLobbySlot = _users.GetChild(0).GetComponent<UserInLobbySlot>();

            for (int i = 0; i < 4; i++)
                _userInLobbySlots.Add(Instantiate(_userInLobbySlot, _users));
